...
const profileSets = {
  couple: {
    ...
    4:{ name:"Le Passerelle", color:"var(--q4)",
      desc:"Dans ton couple, ce que tu dis et ce que tu fais se rejoignent, et ça se sent. Tu es à la fois énergique et tourné(e) vers l'autre. C'est la « zone de concordance », celle où l'échange coule naturellement — celle vers laquelle tous les couples tendent.",
  ...
  famille: {
    ...
    2:{ name:"L'Intense", color:"var(--q2)",
      ...
      vigilance:["La généralisation est ton piège n°1 : « vous ne m'écoutez JAMAIS »","Le besoin d'avoir raison prend parfois toute la place dans l'échange","Le risque : gagner la discussion et laisser une vraie distance derrière"],
